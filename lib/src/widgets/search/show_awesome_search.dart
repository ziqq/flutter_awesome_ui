...
class AwesomeSearch<T> extends StatefulWidget {
  const AwesomeSearch({
    required this.delegate,
    this.animation,
  });
  ...
  @override
  State<StatefulWidget> createState() => _AwesomeSearchState<T>();
}

class _AwesomeSearchState<T> extends State<AwesomeSearch<T>> {
  ...
  @override
  void didUpdateWidget(AwesomeSearch<T> oldWidget) {
